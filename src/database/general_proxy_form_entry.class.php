...
class general_proxy_form_entry extends base_form_entry
{
  ...
  public function get_errors()
  {
    ...
    if( !is_null( $this->proxy_first_name ) ||
        ...
        !is_null( $this->proxy_address_international ) ||
        ...
        !is_null( $this->proxy_international_region ) ||
        !is_null( $this->proxy_international_country_id ) ||
        !is_null( $this->proxy_postcode ) ||
        !is_null( $this->proxy_address_note ) ||
        !is_null( $this->proxy_phone_international ) ||
        ...
        !is_null( $this->proxy_note ) )
    {
      ...
      if( is_null( $this->proxy_address_international ) )
        $errors['proxy_address_international'] = 'Cannot be blank.';
      ...
      if( $this->proxy_address_international )
      {
        if( is_null( $this->proxy_international_country_id ) )
          $errors['proxy_international_country_id'] = 'Cannot be blank.';
      }
      else
      {
        ...
        if( is_null( $this->proxy_postcode ) ) $errors['proxy_postcode'] = 'Cannot be blank.';
      ...
      if( is_null( $this->proxy_phone_international ) )
        $errors['proxy_phone_international'] = 'Cannot be blank.';
      if( is_null( $this->proxy_phone ) )
        $errors['proxy_phone'] = 'Cannot be blank.';
      else if( !$this->proxy_phone_international &&
               !util::validate_north_american_phone_number( $this->proxy_phone ) )
    ...
    if( !is_null( $this->informant_first_name ) ||
        ...
        !is_null( $this->informant_address_international ) ||
        ...
        !is_null( $this->informant_phone_international ) ||
        ...
        !is_null( $this->informant_note ) )
    {
      ...
      if( is_null( $this->informant_address_international ) )
        $errors['informant_address_international'] = 'Cannot be blank.';
      ...
      if( $this->informant_address_international )
      {
        if( is_null( $this->informant_international_country_id ) )
          $errors['informant_international_country_id'] = 'Cannot be blank.';
      }
      else
      {
      ...
      if( is_null( $this->informant_phone_international ) )
        $errors['informant_phone_international'] = 'Cannot be blank.';
      if( is_null( $this->informant_phone ) )
        $errors['informant_phone'] = 'Cannot be blank.';
      else if( !$this->informant_phone_international &&
               !util::validate_north_american_phone_number( $this->informant_phone ) )
