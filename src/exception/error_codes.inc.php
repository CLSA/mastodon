...
define( 'ARGUMENT__MASTODON_DATABASE_PARTICIPANT_DATA__IS_AVAILABLE__ERRNO',
        ARGUMENT_MASTODON_BASE_ERRNO + 2 );
define( 'ARGUMENT__MASTODON_DATABASE_PARTICIPANT_DATA__GENERATE__ERRNO',
        ARGUMENT_MASTODON_BASE_ERRNO + 3 );
define( 'ARGUMENT__MASTODON_DATABASE_PARTICIPANT_DATA__GET_FILENAME__ERRNO',
...
define( 'ARGUMENT__MASTODON_SERVICE_PARTICIPANT_DATA_PARTICIPANT_DATA_TEMPLATE_PATCH__SETUP__ERRNO',
        ARGUMENT_MASTODON_BASE_ERRNO + 6 );
define( 'ARGUMENT__MASTODON_SERVICE_PARTICIPANT_DATA_TEMPLATE_GET__GET_DOWNLOADABLE_PUBLIC_NAME__ERRNO',
        ARGUMENT_MASTODON_BASE_ERRNO + 7 );
define( 'ARGUMENT__MASTODON_SERVICE_PARTICIPANT_DATA_TEMPLATE_GET__GET_DOWNLOADABLE_FILE_PATH__ERRNO',
 ...
 * "runtime" error codes
 */
define( 'RUNTIME__MASTODON_DATABASE_APPLICATION__RELEASE_PARTICIPANTS__ERRNO',
...
define( 'RUNTIME__MASTODON_DATABASE_PARTICIPANT_DATA__GENERATE__ERRNO',
...
define( 'RUNTIME__MASTODON_SERVICE_GENERAL_PROXY_FORM_POST__EXECUTE__ERRNO',
