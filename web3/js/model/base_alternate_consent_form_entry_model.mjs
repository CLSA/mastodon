              ...
              typeahead: {
                ...
                get_list: async (value, form_input) => {
                  const participant_id =
                    await form_input.get_action().get_property_value_for_record("participant_id");
                  return (
                    !participant_id ?
                    [] :
                    await CN_api.get(`participant/${participant_id}/alternate`, {
                      select: {
                        column: [{
                          table: "alternate",
                          column: "id",
                      ...
                      modifier: {
                        where: [
                          ...
                          { column: "alternate_type_list", operator: "LIKE", value: "%Information Provider%" },
                          { column: "alternate_type_list", operator: "LIKE", value: "%Decision Maker%", or: true },
