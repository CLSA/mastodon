...
const { CN_export_restriction_model } = await import(`${CENOZO_URL}/js/model/export_restriction.mjs`);

export class CN_export_restriction_model extends CN_export_restriction_model {
  /**
