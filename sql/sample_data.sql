...
INSERT INTO site( name, type, timezone ) VALUES
...
UPDATE region SET site_id = ( SELECT id FROM site WHERE name = "Victoria" AND type = "tracking" )
WHERE abbreviation = "AB";
UPDATE region SET site_id = ( SELECT id FROM site WHERE name = "Victoria" AND type = "tracking" )
WHERE abbreviation = "BC";
UPDATE region SET site_id = ( SELECT id FROM site WHERE name = "Manitoba" AND type = "tracking" )
WHERE abbreviation = "MB";
UPDATE region SET site_id = ( SELECT id FROM site WHERE name = "Dalhousie" AND type = "tracking" )
...
UPDATE region SET site_id = ( SELECT id FROM site WHERE name = "McMaster" AND type = "tracking" )
WHERE abbreviation = "ON";
UPDATE region SET site_id = ( SELECT id FROM site WHERE name = "Dalhousie" AND type = "tracking" )
WHERE abbreviation = "PE";
UPDATE region SET site_id = ( SELECT id FROM site WHERE name = "Sherbrooke" AND type = "tracking" )
...
SET user_id = ( SELECT id FROM user WHERE name = "patrick" ),
    ...
    site_id = ( SELECT id FROM site WHERE name = "McMaster" AND type = "tracking" );
INSERT INTO access
SET user_id = ( SELECT id FROM user WHERE name = "patrick" ),
...
SET user_id = ( SELECT id FROM user WHERE name = "patrick" ),
    role_id = ( SELECT id FROM role WHERE name = "supervisor" ),
    site_id = ( SELECT id FROM site WHERE name = "Hamilton" AND type = "comprehensive" );
INSERT INTO access
SET user_id = ( SELECT id FROM user WHERE name = "patrick" ),
    role_id = ( SELECT id FROM role WHERE name = "operator" ),
    site_id = ( SELECT id FROM site WHERE name = "Hamilton" AND type = "comprehensive" );
...
SET user_id = ( SELECT id FROM user WHERE name = "patrick" ),
    role_id = ( SELECT id FROM role WHERE name = "supervisor" ),
    site_id = ( SELECT id FROM site WHERE name = "Manitoba" AND type = "tracking" );
INSERT INTO access
SET user_id = ( SELECT id FROM user WHERE name = "patrick" ),
    role_id = ( SELECT id FROM role WHERE name = "operator" ),
    site_id = ( SELECT id FROM site WHERE name = "Manitoba" AND type = "tracking" );
