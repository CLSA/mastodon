...
class contact_form_entry_view extends base_form_entry_view
{
  ...
  public function __construct( $args )
  {
    ...
    $this->add_item( 'box', 'number', 'Post Office Box #' );
    $this->add_item( 'rural_route', 'number', 'Rural Route #' );
    ...
    $this->add_item( 'phone_preference', 'boolean', 'Phone Preference' );
  ...
  public function finish()
  {
    ...
    $gender_list = $contact_form_entry::get_enum_values( 'gender' );
    $gender_list = array_combine( $gender_list, $gender_list );
    $age_bracket_list = $contact_form_entry::get_enum_values( 'age_bracket' );
    $age_bracket_list = array_combine( $age_bracket_list, $age_bracket_list );
    $language_list = $contact_form_entry::get_enum_values( 'language' );
    $language_list = array_combine( $language_list, $language_list );
    $cohort_list = $contact_form_entry::get_enum_values( 'cohort' );
    ...
    $this->set_item( 'phone_preference', $this->get_record->phone_preference, false );
    ...
    $this->set_item( 'monday', $this->get_record->monday, false );
    $this->set_item( 'tuesday', $this->get_record->tuesday, false );
    $this->set_item( 'wednesday', $this->get_record->wednesday, false );
    $this->set_item( 'thursday', $this->get_record->thursday, false );
    $this->set_item( 'friday', $this->get_record->friday, false );
    $this->set_item( 'saturday', $this->get_record->saturday, false );
    $this->set_item( 'time_9_10', $this->get_record->time_9_10, false );
    $this->set_item( 'time_10_11', $this->get_record->time_10_11, false );
    $this->set_item( 'time_11_12', $this->get_record->time_11_12, false );
    $this->set_item( 'time_12_13', $this->get_record->time_12_13, false );
    $this->set_item( 'time_13_14', $this->get_record->time_13_14, false );
    $this->set_item( 'time_14_15', $this->get_record->time_14_15, false );
    $this->set_item( 'time_15_16', $this->get_record->time_15_16, false );
    $this->set_item( 'time_16_17', $this->get_record->time_16_17, false );
    $this->set_item( 'time_17_18', $this->get_record->time_17_18, false );
    $this->set_item( 'time_18_19', $this->get_record->time_18_19, false );
    $this->set_item( 'time_19_20', $this->get_record->time_19_20, false );
    $this->set_item( 'time_20_21', $this->get_record->time_20_21, false );
    $this->set_item( 'language', $this->get_record->language, false, $language_list );
