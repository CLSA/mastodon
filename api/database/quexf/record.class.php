...
namespace mastodon\database\quexf;
use cenozo\lib, cenozo\log, mastodon\util;


/**
 * This is the abstract database table object for all quexf tables.
 * 
 * @package mastodon\database
 */
abstract class record extends \cenozo\database\record
{
   ...
   * Magic call method.
   * 
   * Disables the parent method so that it is compatible with quexf tables.
   * @author Patrick Emond <emondpd@mcmaster.ca>
   ...
   * 
   * Overrides the parent method so that it is compatible with quexf tables.
   * @author Patrick Emond <emondpd@mcmaster.ca>
  ...
  {
    return lib::create( 'business\session' )->get_quexf_database();
  }
}
?>
