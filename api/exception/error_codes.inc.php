...
define( 'ARGUMENT__MASTODON_UI_PUSH_ADDRESS_DELETE__CONVERT_FROM_NOID__ERRNO',
        ARGUMENT_MASTODON_BASE_ERRNO + 6 );
define( 'ARGUMENT__MASTODON_UI_PUSH_ADDRESS_EDIT__CONVERT_FROM_NOID__ERRNO',
        ARGUMENT_MASTODON_BASE_ERRNO + 7 );
define( 'ARGUMENT__MASTODON_UI_PUSH_PHONE_DELETE__CONVERT_FROM_NOID__ERRNO',
        ARGUMENT_MASTODON_BASE_ERRNO + 8 );
define( 'ARGUMENT__MASTODON_UI_PUSH_PHONE_EDIT__CONVERT_FROM_NOID__ERRNO',
        ARGUMENT_MASTODON_BASE_ERRNO + 9 );
define( 'ARGUMENT__MASTODON_UI_WIDGET_IMPORT_ADD__FINISH__ERRNO',
...
define( 'NOTICE__MASTODON_UI_PUSH_IMPORT_NEW__FINISH__ERRNO',
...
define( 'RUNTIME__MASTODON_UI_PUSH_ADDRESS_NEW__CONVERT_FROM_NOID__ERRNO',
        RUNTIME_MASTODON_BASE_ERRNO + 6 );
define( 'RUNTIME__MASTODON_UI_PUSH_ALTERNATE_NEW__FINISH__ERRNO',
        RUNTIME_MASTODON_BASE_ERRNO + 7 );
define( 'RUNTIME__MASTODON_UI_PUSH_BASE_FORM_ADJUDICATE__FINISH__ERRNO',
        RUNTIME_MASTODON_BASE_ERRNO + 8 );
define( 'RUNTIME__MASTODON_UI_PUSH_BASE_FORM_ENTRY_EDIT__FINISH__ERRNO',
        RUNTIME_MASTODON_BASE_ERRNO + 9 );
define( 'RUNTIME__MASTODON_UI_PUSH_CONSENT_NEW__FINISH__ERRNO',
        RUNTIME_MASTODON_BASE_ERRNO + 10 );
define( 'RUNTIME__MASTODON_UI_PUSH_NOTE_DELETE__CONVERT_FROM_NOID__ERRNO',
        RUNTIME_MASTODON_BASE_ERRNO + 11 );
define( 'RUNTIME__MASTODON_UI_PUSH_NOTE_EDIT__CONVERT_FROM_NOID__ERRNO',
...
define( 'RUNTIME__MASTODON_UI_PUSH_PHONE_NEW__CONVERT_FROM_NOID__ERRNO',
