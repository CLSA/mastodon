define(function () {
  ...
  try {
    var module = cenozoApp.module("dm_consent_form", true);
  } catch (err) {
    console.warn(err);
    return;
  }
      ...
      return {
        ...
        controller: function ($scope) {
          if (angular.isUndefined($scope.model))
            $scope.model = CnDmConsentFormModelFactory.root;
        },
      };
    },
  ]);
  ...
  cenozo.providers.factory("CnDmConsentFormAdjudicateFactory", [
    "CnBaseFormAdjudicateFactory", "CnDmConsentFormModelFactory",
    function (CnBaseFormAdjudicateFactory, CnDmConsentFormModelFactory) {
      var object = function (parentModel) {
        ...
        this.parentModel = CnDmConsentFormModelFactory.root;
      };
      return {
  ...
  cenozo.providers.factory("CnDmConsentFormModelFactory", [
    ...
    "CnDmConsentFormListFactory",
    "CnDmConsentFormViewFactory",
    function (
      CnBaseFormModelFactory,
      CnDmConsentFormListFactory,
      CnDmConsentFormViewFactory
