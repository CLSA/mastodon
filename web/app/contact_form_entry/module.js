define(function () {
  ...
  try {
    var module = cenozoApp.module("contact_form_entry", true);
  } catch (err) {
    console.warn(err);
    return;
  }
      ...
      return {
        ...
        controller: function ($scope) {
          if (angular.isUndefined($scope.model))
            $scope.model = CnContactFormEntryModelFactory.root;
        },
      };
    },
  ]);
  ...
  cenozo.providers.factory("CnContactFormEntryModelFactory", [
    ...
    "CnContactFormEntryListFactory",
    "CnContactFormEntryViewFactory",
    function (
      CnBaseFormEntryModelFactory,
      CnContactFormEntryListFactory,
      CnContactFormEntryViewFactory
