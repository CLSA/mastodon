define(function () {
  ...
  try {
    var module = cenozoApp.module("dm_consent_form_entry", true);
  } catch (err) {
    console.warn(err);
    return;
  }
      ...
      return {
        ...
        controller: function ($scope) {
          if (angular.isUndefined($scope.model))
            $scope.model = CnDmConsentFormEntryModelFactory.root;
        },
      };
    },
  ]);
  ...
  cenozo.providers.factory("CnDmConsentFormEntryModelFactory", [
    ...
    "CnDmConsentFormEntryListFactory",
    "CnDmConsentFormEntryViewFactory",
    function (
      CnBaseFormEntryModelFactory,
      CnDmConsentFormEntryListFactory,
      CnDmConsentFormEntryViewFactory
