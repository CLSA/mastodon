define(function () {
  ...
  try {
    var module = cenozoApp.module("hin_form", true);
  } catch (err) {
    console.warn(err);
    return;
  }
      ...
      return {
        ...
        controller: function ($scope) {
          if (angular.isUndefined($scope.model))
            $scope.model = CnHinFormModelFactory.root;
        },
      };
    },
  ]);
  ...
  cenozo.providers.factory("CnHinFormAdjudicateFactory", [
    "CnBaseFormAdjudicateFactory", "CnHinFormModelFactory",
    function (CnBaseFormAdjudicateFactory, CnHinFormModelFactory) {
      var object = function (parentModel) {
        ...
        this.parentModel = CnHinFormModelFactory.root;
      };
      return {
  ...
  cenozo.providers.factory("CnHinFormModelFactory", [
    ...
    "CnHinFormListFactory",
    "CnHinFormViewFactory",
    function (
      CnBaseFormModelFactory,
      CnHinFormListFactory,
      CnHinFormViewFactory
