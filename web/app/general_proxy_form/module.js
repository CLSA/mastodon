define( function() {
  ...
  try { var module = cenozoApp.module( 'general_proxy_form', true ); } catch( err ) { console.warn( err ); return; }
  ...
  cenozo.providers.directive( 'cnGeneralProxyFormList', [
    ...
    function( CnGeneralProxyFormModelFactory ) {
      return {
        ...
        scope: { model: '=?' },
        controller: function( $scope ) {
          if( angular.isUndefined( $scope.model ) ) $scope.model = CnGeneralProxyFormModelFactory.root;
        }
      };
    }
  ] );
  ...
  cenozo.providers.factory( 'CnGeneralProxyFormModelFactory', [
    'CnBaseFormModelFactory', 'CnGeneralProxyFormListFactory', 'CnGeneralProxyFormViewFactory',
    function( CnBaseFormModelFactory, CnGeneralProxyFormListFactory, CnGeneralProxyFormViewFactory ) {
