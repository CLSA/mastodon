CREATE TABLE consent_form (
  ...
  validated_consent_form_entry_id int(10) unsigned DEFAULT NULL COMMENT 'The entry data which has been validated and accepted.',
  date date NOT NULL,
  PRIMARY KEY (id),
  KEY fk_validated_consent_form_entry_id (validated_consent_form_entry_id),
