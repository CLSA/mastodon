...
-- Schema mastodon
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `mastodon` DEFAULT CHARACTER SET utf8mb4 ;
USE `cenozo` ;
...
-- -----------------------------------------------------
-- Table `mastodon`.`custom_report`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mastodon`.`custom_report` (
...
-- -----------------------------------------------------
-- Table `mastodon`.`dm_consent_form`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mastodon`.`dm_consent_form` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `form_id` INT(10) UNSIGNED NULL DEFAULT NULL,
  ...
  CONSTRAINT `fk_dm_consent_form_dm_consent_form_entry_id`
    ...
    REFERENCES `mastodon`.`dm_consent_form_entry` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `mastodon`.`dm_consent_form_entry`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mastodon`.`dm_consent_form_entry` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  ...
  CONSTRAINT `fk_dm_consent_form_entry_dm_consent_form_id`
    ...
    REFERENCES `mastodon`.`dm_consent_form` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `mastodon`.`dm_consent_form_total`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mastodon`.`dm_consent_form_total` (
  `dm_consent_form_id` INT(10) UNSIGNED NOT NULL,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `entry_total` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `mastodon`.`extended_hin_form`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mastodon`.`extended_hin_form` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `form_id` INT(10) UNSIGNED NULL DEFAULT NULL,
  ...
  CONSTRAINT `fk_extended_hin_form_extended_hin_form_entry_id`
    ...
    REFERENCES `mastodon`.`extended_hin_form_entry` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `mastodon`.`extended_hin_form_entry`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mastodon`.`extended_hin_form_entry` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  ...
  CONSTRAINT `fk_extended_hin_form_entry_extended_hin_form_id`
    ...
    REFERENCES `mastodon`.`extended_hin_form` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `mastodon`.`extended_hin_form_total`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mastodon`.`extended_hin_form_total` (
  `extended_hin_form_id` INT(10) UNSIGNED NOT NULL,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `entry_total` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `mastodon`.`general_proxy_form`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mastodon`.`general_proxy_form` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `form_id` INT(10) UNSIGNED NULL DEFAULT NULL,
  ...
  CONSTRAINT `fk_general_proxy_form_validated_general_proxy_form_entry_id`
    ...
    REFERENCES `mastodon`.`general_proxy_form_entry` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
...
-- -----------------------------------------------------
-- Table `mastodon`.`general_proxy_form_entry`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mastodon`.`general_proxy_form_entry` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  ...
  CONSTRAINT `fk_general_proxy_form_entry_general_proxy_form_id`
    ...
    REFERENCES `mastodon`.`general_proxy_form` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `mastodon`.`general_proxy_form_total`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mastodon`.`general_proxy_form_total` (
  `general_proxy_form_id` INT(10) UNSIGNED NOT NULL,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `entry_total` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `mastodon`.`ip_consent_form`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mastodon`.`ip_consent_form` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `form_id` INT(10) UNSIGNED NULL DEFAULT NULL,
  ...
  CONSTRAINT `fk_ip_consent_form_ip_consent_form_entry_id`
    ...
    REFERENCES `mastodon`.`ip_consent_form_entry` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
...
-- -----------------------------------------------------
-- Table `mastodon`.`ip_consent_form_entry`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mastodon`.`ip_consent_form_entry` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  ...
  CONSTRAINT `fk_ip_consent_form_entry_ip_consent_form_id`
    ...
    REFERENCES `mastodon`.`ip_consent_form` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `mastodon`.`ip_consent_form_total`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mastodon`.`ip_consent_form_total` (
  `ip_consent_form_id` INT(10) UNSIGNED NOT NULL,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `entry_total` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `mastodon`.`participant_data`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mastodon`.`participant_data` (
...
-- -----------------------------------------------------
-- Table `mastodon`.`participant_data_has_cohort`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mastodon`.`participant_data_has_cohort` (
  ...
  CONSTRAINT `fk_participant_data_has_cohort_participant_data_id`
    ...
    REFERENCES `mastodon`.`participant_data` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `mastodon`.`participant_data_template`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mastodon`.`participant_data_template` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
...
-- -----------------------------------------------------
-- Table `mastodon`.`role_has_custom_report`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mastodon`.`role_has_custom_report` (
  `role_id` INT(10) UNSIGNED NOT NULL,
  ...
  CONSTRAINT `fk_role_has_custom_report_custom_report_id`
    ...
    REFERENCES `mastodon`.`custom_report` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `mastodon`.`role_has_service` (
  ...
  CONSTRAINT `fk_role_has_service_service_id`
    ...
    REFERENCES `mastodon`.`service` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
...
DELIMITER $$
USE `mastodon`$$
CREATE DEFINER=`patrick`@`localhost` PROCEDURE `update_consent_form_total`( IN proc_consent_form_id INT(10) UNSIGNED )
BEGIN
...
DELIMITER $$
USE `mastodon`$$
CREATE DEFINER=`patrick`@`localhost` PROCEDURE `update_contact_form_total`(IN proc_contact_form_id INT(10) UNSIGNED)
BEGIN
...
-- -----------------------------------------------------
-- procedure update_dm_consent_form_total
-- -----------------------------------------------------

DELIMITER $$
USE `mastodon`$$
CREATE DEFINER=`patrick`@`localhost` PROCEDURE `update_dm_consent_form_total`( IN proc_dm_consent_form_id INT(10) UNSIGNED )
BEGIN
  -- NOTE: this procedure is created dynamically by aux/create_dynamic_procedures since it references the cenozo db
END$$
...
-- -----------------------------------------------------
-- procedure update_extended_hin_form_total
-- -----------------------------------------------------

DELIMITER $$
USE `mastodon`$$
CREATE DEFINER=`patrick`@`localhost` PROCEDURE `update_extended_hin_form_total`( IN proc_extended_hin_form_id INT(10) UNSIGNED )
BEGIN
  -- NOTE: this procedure is created dynamically by aux/create_dynamic_procedures since it references the cenozo db
END$$
...
-- -----------------------------------------------------
-- procedure update_general_proxy_form_total
-- -----------------------------------------------------

DELIMITER $$
USE `mastodon`$$
CREATE DEFINER=`patrick`@`localhost` PROCEDURE `update_general_proxy_form_total`( IN proc_general_proxy_form_id INT(10) UNSIGNED )
BEGIN
  -- NOTE: this procedure is created dynamically by aux/create_dynamic_procedures since it references the cenozo db
END$$
...
DELIMITER $$
USE `mastodon`$$
CREATE DEFINER=`patrick`@`localhost` PROCEDURE `update_hin_form_total`( IN proc_hin_form_id INT(10) UNSIGNED )
BEGIN
  -- NOTE: this procedure is created dynamically by aux/create_dynamic_procedures since it references the cenozo db
END$$
...
-- -----------------------------------------------------
-- procedure update_ip_consent_form_total
-- -----------------------------------------------------

DELIMITER $$
USE `mastodon`$$
CREATE DEFINER=`patrick`@`localhost` PROCEDURE `update_ip_consent_form_total`( IN proc_ip_consent_form_id INT(10) UNSIGNED )
BEGIN
  -- NOTE: this procedure is created dynamically by aux/create_dynamic_procedures since it references the cenozo db
END$$
...
-- -----------------------------------------------------
-- procedure update_proxy_consent_form_total
-- -----------------------------------------------------

DELIMITER $$
USE `mastodon`$$
CREATE DEFINER=`patrick`@`localhost` PROCEDURE `update_proxy_consent_form_total`( IN proc_proxy_consent_form_id INT(10) UNSIGNED )
BEGIN
  -- NOTE: this procedure is created dynamically by aux/create_dynamic_procedures since it references the cenozo db
END$$
...
DELIMITER $$
USE `mastodon`$$
CREATE DEFINER=`patrick`@`localhost` PROCEDURE `update_proxy_form_total`( IN proc_proxy_form_id INT(10) UNSIGNED )
BEGIN
  -- NOTE: this procedure is created dynamically by aux/create_dynamic_procedures since it references the cenozo db
END$$
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `mastodon`.`consent_form_AFTER_INSERT`
...
USE `mastodon`$$
CREATE DEFINER = CURRENT_USER TRIGGER `mastodon`.`consent_form_AFTER_UPDATE` AFTER UPDATE ON `consent_form` FOR EACH ROW
BEGIN
  CALL update_consent_form_total( NEW.id );
END$$
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `mastodon`.`consent_form_entry_AFTER_DELETE`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `mastodon`.`consent_form_entry_AFTER_INSERT`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `mastodon`.`consent_form_entry_AFTER_UPDATE`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `mastodon`.`contact_form_AFTER_INSERT`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `mastodon`.`contact_form_entry_AFTER_DELETE`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `mastodon`.`contact_form_entry_AFTER_INSERT`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `mastodon`.`contact_form_entry_AFTER_UPDATE`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `mastodon`.`dm_consent_form_AFTER_INSERT`
...
USE `mastodon`$$
CREATE DEFINER = CURRENT_USER TRIGGER `mastodon`.`dm_consent_form_AFTER_UPDATE` AFTER UPDATE ON `dm_consent_form` FOR EACH ROW
BEGIN
  CALL update_dm_consent_form_total( NEW.id );
END$$
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `mastodon`.`dm_consent_form_entry_AFTER_DELETE`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `mastodon`.`dm_consent_form_entry_AFTER_INSERT`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `mastodon`.`dm_consent_form_entry_AFTER_UPDATE`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `mastodon`.`extended_hin_form_AFTER_INSERT`
...
USE `mastodon`$$
CREATE DEFINER = CURRENT_USER TRIGGER `mastodon`.`extended_hin_form_AFTER_UPDATE` AFTER UPDATE ON `extended_hin_form` FOR EACH ROW
BEGIN
  CALL update_extended_hin_form_total( NEW.id );
END$$
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `mastodon`.`extended_hin_form_entry_AFTER_DELETE`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `mastodon`.`extended_hin_form_entry_AFTER_INSERT`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `mastodon`.`extended_hin_form_entry_AFTER_UPDATE`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `mastodon`.`general_proxy_form_AFTER_INSERT`
...
USE `mastodon`$$
CREATE DEFINER = CURRENT_USER TRIGGER `mastodon`.`general_proxy_form_AFTER_UPDATE` AFTER UPDATE ON `general_proxy_form` FOR EACH ROW
BEGIN
  CALL update_general_proxy_form_total( NEW.id );
END$$
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `mastodon`.`general_proxy_form_entry_AFTER_INSERT`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `mastodon`.`general_proxy_form_entry_AFTER_UPDATE`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `mastodon`.`general_proxy_form_entry_AFTER_DELETE`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `mastodon`.`hin_form_AFTER_INSERT`
...
USE `mastodon`$$
CREATE DEFINER = CURRENT_USER TRIGGER `mastodon`.`hin_form_AFTER_UPDATE` AFTER UPDATE ON `hin_form` FOR EACH ROW
BEGIN
  CALL update_hin_form_total( NEW.id );
END$$
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `mastodon`.`hin_form_entry_AFTER_DELETE`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `mastodon`.`hin_form_entry_AFTER_INSERT`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `mastodon`.`hin_form_entry_AFTER_UPDATE`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `mastodon`.`ip_consent_form_AFTER_INSERT`
...
USE `mastodon`$$
CREATE DEFINER = CURRENT_USER TRIGGER `mastodon`.`ip_consent_form_AFTER_UPDATE` AFTER UPDATE ON `ip_consent_form` FOR EACH ROW
BEGIN
  CALL update_ip_consent_form_total( NEW.id );
END$$
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `mastodon`.`ip_consent_form_entry_AFTER_DELETE`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `mastodon`.`ip_consent_form_entry_AFTER_INSERT`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `mastodon`.`ip_consent_form_entry_AFTER_UPDATE`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `mastodon`.`proxy_form_AFTER_INSERT`
...
USE `mastodon`$$
CREATE DEFINER = CURRENT_USER TRIGGER `mastodon`.`proxy_form_AFTER_UPDATE` AFTER UPDATE ON `proxy_form` FOR EACH ROW
BEGIN
  CALL update_proxy_form_total( NEW.id );
END$$
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `mastodon`.`proxy_form_entry_AFTER_DELETE`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `mastodon`.`proxy_form_entry_AFTER_INSERT`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `mastodon`.`proxy_form_entry_AFTER_UPDATE`
