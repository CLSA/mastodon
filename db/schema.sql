...
-- Tue 19 Apr 2016 04:16:13 PM EDT
...
-- -----------------------------------------------------
-- Table `mastodon`.`consent_form_count`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mastodon`.`consent_form_count` ;

CREATE TABLE IF NOT EXISTS `mastodon`.`consent_form_count` (
  `consent_form_id` INT UNSIGNED NOT NULL,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `entries` INT UNSIGNED NULL,
  `completed_entries` INT UNSIGNED NULL,
  PRIMARY KEY (`consent_form_id`),
  CONSTRAINT `fk_consent_form_count_consent_form_id1`
    FOREIGN KEY (`consent_form_id`)
    REFERENCES `mastodon`.`consent_form` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `mastodon`.`consent_form_count_copy1`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mastodon`.`consent_form_count_copy1` ;

CREATE TABLE IF NOT EXISTS `mastodon`.`consent_form_count_copy1` (
  `consent_form_id` INT UNSIGNED NOT NULL,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `entries` INT UNSIGNED NULL,
  `completed_entries` INT UNSIGNED NULL,
  PRIMARY KEY (`consent_form_id`),
  CONSTRAINT `fk_consent_form_count_consent_form_id10`
    FOREIGN KEY (`consent_form_id`)
    REFERENCES `mastodon`.`consent_form` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
